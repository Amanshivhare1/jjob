#!/usr/bin/env python3
"""
Universal startup script for Tidal Dashboard
...
def print_header():
    ...
    print("=" * 50)
    print("  Tidal Dashboard - Universal Setup")
    print("=" * 50)
...
def create_directories():
    ...
    directories = ['sample_data', 'logs', 'templates']
...
def main():
    ...
    print("2. Open your browser: http://localhost:3002")
    print("3. Login with:")
    ...
    try:
        ...
        if start_server in ['y', 'yes']:
            print("\n🌐 Starting server...")
            print("📊 Dashboard will be available at: http://localhost:3002")
